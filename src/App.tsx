...
import type { LettersUseProps } from "./components/LettersUsed"

const attempt_margin = 5

export default function App() {
  const [score, setScore] = useState(0)
  const [lettersUsed, setLettersUsed] = useState<LettersUseProps[]>([])
      ...
      <div className={styles.word}>
        {
          challenge.word.split("").map((letter, index) => {
            const letterUsed = lettersUsed.find((used) => 
              used.value.toUpperCase() === letter.toUpperCase()
            )
